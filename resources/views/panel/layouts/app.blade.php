    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Element</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="{{route("table")}}">
                    ...
                    <span class="nav-link-text ms-1">Element Listele</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="{{route("panel.form.index")}}">
                    ...
                    <span class="nav-link-text ms-1">Element Oluştur</span>
                </a>
            </li>
